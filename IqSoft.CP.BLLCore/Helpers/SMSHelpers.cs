...
namespace IqSoft.CP.BLL.Helpers
{
    ...
    {
        public static void SendSMS(int notificationServiceId, ApiSMSModel apiSMSModel)
        {
        ...
        private static void SendSmsToNeximo(ApiSMSModel apiSMSModel)
        {
            string sender = CacheManager.GetNotificationServiceValueByKey(apiSMSModel.PartnerId, Constants.PartnerKeys.SmsSender, (int)NotificationServices.Nexmo);
            string apiKey = CacheManager.GetNotificationServiceValueByKey(apiSMSModel.PartnerId, Constants.PartnerKeys.SmsGwLogin, (int)NotificationServices.Nexmo);
            string apiSecret = CacheManager.GetNotificationServiceValueByKey(apiSMSModel.PartnerId, Constants.PartnerKeys.SmsGwPass, (int)NotificationServices.Nexmo);
        ...
        public static void SendSmsToSMSTo(ApiSMSModel apiSMSModel)
        {
