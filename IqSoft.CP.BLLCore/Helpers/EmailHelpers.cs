...
namespace IqSoft.CP.BLL.Helpers
{
    ...
    {
        public static void SendEmail(int notificationServiceId, ApiEmailModel apiEmailModel)
        {
        ...
        private static void SendUnisender(ApiEmailModel apiEmailModel)
        {
            var partner = CacheManager.GetPartnerById(apiEmailModel.ParnerId);
