...
{
    [ApiController]
    public class IqSoftBetShopGamesController : ControllerBase
    {
        [HttpPost]
        ...
        public IActionResult Debit(ApiFinOperationInput input)
        {
            try
            {
        ...
        public IActionResult CheckCashierToken(TokenOperationInput input)
        {
            try
            {
                var response = new ResponseBase();
