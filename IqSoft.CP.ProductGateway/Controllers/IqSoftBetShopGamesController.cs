...
namespace IqSoft.CP.ProductGateway.Controllers
{
    ...
    public class IqSoftBetShopGamesController : ApiController
    {
        [HttpPost]
        [Route("{partnerId}/api/IqSoftBetShopGames/Authorization")]
        ...
        [HttpPost]
        [Route("{partnerId}/api/IqSoftBetShopGames/GetBalance")]
        public IHttpActionResult GetBalance(GetBalanceInput input)
        {
            try
            {
				...
				using (var betShopBl = new BetShopBll(sessionIdentity, WebApiApplication.DbLogger))
				{
					using (var documentBl = new DocumentBll(betShopBl))
					{
						...
						var operationsFromProduct = new ListOfOperationsFromApi
						{
							...
							GameProviderId = CacheManager.GetGameProviderByName(Constants.GameProviders.IqSoft).Id,
            ...
            try
            {
                using (var betShopBl = new BetShopBll(new SessionIdentity(), WebApiApplication.DbLogger))
                {
					using (var documentBl = new DocumentBll(betShopBl))
					{
						...
						var gameProviderId = CacheManager.GetGameProviderByName(Constants.GameProviders.IqSoft).Id;
        ...
        [HttpPost]
        [Route("{partnerId}/api/IqSoftBetShopGames/RollBack")]
        ...
        [HttpPost]
        [Route("{partnerId}/api/IqSoftBetShopGames/CheckCashierToken")]
        public IHttpActionResult CheckCashierToken(TokenOperationInput input)
        {
            try
            {
