...
{
    public class DriveMediaController : ApiController
    {
        [HttpPost]
        [Route("{partnerId}/api/DriveMedia/ApiRequest")]
        public IHttpActionResult ApiRequest(int partnerId, BaseInput input)
        {
            ...
            WebApiApplication.DbLogger.Info(JsonConvert.SerializeObject(JsonConvert.SerializeObject(response)));
            return Ok(response);
        }

        private IHttpActionResult GetBalance(int partnerId, BaseInput input)
        {
            BaseOutput response = null;
        ...
        private IHttpActionResult WriteBet(int partnerId, BaseInput input)
        {
        ...
        private Document Bet(ClientBll clientBl, BllClient client, BaseInput input, SessionIdentity clientSession, DocumentBll documentBl)
        {
            ...
            var res = clientBl.CreateCreditFromClient(operationsFromProduct, documentBl, out LimitInfo info);
