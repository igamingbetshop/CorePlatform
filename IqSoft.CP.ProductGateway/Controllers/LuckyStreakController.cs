...
namespace IqSoft.CP.ProductGateway.Controllers
{
	public class LuckyStreakController : ApiController
	{
		...
		public HttpResponseMessage ApiRequest(HttpRequestMessage httpRequestMessage)
		{
			...
			//	var clientSession = ClientBll.GetClientProductSession(input.Token, Constants.DefaultLanguageId, checkExpiration: true);
			...
			//	var product = CacheManager.GetProductByExternalId(ProviderId, $"{input.GameId},{input.Provider}");
