...
namespace IqSoft.NGGP.WebApplications.ProductGateway.Helpers
{
    ...
    //        WebApiApplication.StringContent = content.ReadAsStringAsync().Result;
    //        string postData = string.Format("Type {0} Body {1} Url {2}", content.Headers.ContentType, WebApiApplication.StringContent, request.RequestUri);
