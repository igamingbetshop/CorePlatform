...
using IqSoft.CP.IqWalletWebApiCore;
...
{
	[ApiController]
	public class IqWalletController : ControllerBase
    {
				...
				using (var documentBl = new DocumentBll(clientBl))
				{
					using (var notificationBl = new NotificationBll(clientBl))
					{
						try
						{
							...
							var resp = clientBl.ChangeWithdrawRequestState(request.Id, PaymentRequestStates.Approved, string.Empty, null, null,
																		   true, request.Parameters, documentBl, notificationBl);
							...
							clientBl.PayWithdrawFromPaymentSystem(resp, documentBl, notificationBl, merchantRequest);
						}
