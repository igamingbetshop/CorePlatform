...
namespace IqSoft.CP.Integration.Payments.Models.WzrdPay
{
    ...
    public class InputAttribute
    {
        ...
        public Urls ReturnUrls { get; set; }
    ...
    {
        [JsonProperty(PropertyName = "split_mode")]
        public bool SplitMode { get; set; }

        [JsonProperty(PropertyName = "parallel_mode")]
        public bool ParallelMode { get; set; }

        [JsonProperty(PropertyName = "allow_partially")]
        public bool AllowPartially { get; set; }

        [JsonProperty(PropertyName = "auto_process")]
