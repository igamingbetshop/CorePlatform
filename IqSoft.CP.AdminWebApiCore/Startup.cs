...
namespace IqSoft.CP.AdminWebApiCore
{
    public class Startup
    {
        ...
        {
            var qParams = new Dictionary<string, string> { { "ProjectId", ((int)ProjectTypes.AdminWebApi).ToString() } };
            ...
            Program.JobHubProxy.On<int, int>("onRemoveBanners", (partnerId, type) =>
            {
            ...
            Program.JobHubProxy.On<int>("onPaymentRequst", (paymentRequestId) =>
            {
