    ...
    public static class CustomMapper
    {
        ...
        public static InternetBetModel MapToInternetBetModel(this fnInternetBet fnInternetBet, double timeZone)
        {
            return new InternetBetModel
            {
                ...
                LastUpdateTime = fnInternetBet.LastUpdateTime
            };
        }
        ...
        public static List<BetshopBetsReportModel> MapToBetshopBetsReportModels(this IEnumerable<BetShopBets> betsReports, double timeZone)
        {
            return betsReports.Select(x => x.MapToBetshopBetsReportModel(timeZone)).ToList();
        }
        ...
        public static Client MapToClient(this ChangeClientDetailsInput input, Client client)
        {
            ...
            return new Client
            {
                ...
                CallToPhone = input.CallToPhone.GetValueOrDefault(),
        ...
        public static Client MapToClient(this NewClientModel input)
        {
            return new Client
            {
                ...
                UserName = string.IsNullOrWhiteSpace(input.UserName) ? string.Empty : input.UserName,
        ...
        public static List<ApiGetBetShopByIdOutput> MapBetshopExtendedModels(this IEnumerable<BetShop> betShops, double timeZone)
        {
            return betShops.Select(x => x.MapToBetshopExtendedModel(timeZone)).ToList();
        }

        public static ApiGetBetShopByIdOutput MapToBetshopExtendedModel(this BetShop betShop, double timeZone)
        {
            return new ApiGetBetShopByIdOutput
            {
                ...
                GroupName = betShop.Group != null ? betShop.Group.Name : string.Empty,
        ...
        public static List<ApiGetBetShopByIdOutput> MapBetshopfnExtendedModels(this IEnumerable<fnBetShops> betShops, double timeZone)
        {
            return betShops.Select(x => x.MapToBetshopfnExtendedModel(timeZone)).ToList();
        }

        public static ApiGetBetShopByIdOutput MapToBetshopfnExtendedModel(this fnBetShops betShop, double timeZone)
        {
            return new ApiGetBetShopByIdOutput
            {
                Id = betShop.Id,
        ...
        public static List<BetshopGroupModel> MapToBetshopGroupModels(this IEnumerable<BetShopGroup> users, double timeZone)
        {
            return users.Select(x => x.MapToBetshopGroupModel(timeZone)).ToList();
        }
        ...
        public static ApiClient MapTofApiClientItem(this fnClient client, double timeZone, string language)
        {
            ...
            return new ApiClient
            {
                ...
                Balance = Math.Floor((client.Balance ?? 0) * 100) / 100,
        ...
        #endregion
        #region fnClient               
        public static List<fnClientModel> MapTofnClientModelList(this IEnumerable<fnClient> arg, double timeZone, bool hideClientContactInfo)
        {
            return arg.Select(x => x.MapTofnClientModelItem(timeZone, hideClientContactInfo)).ToList();
        }

        public static fnClientModel MapTofnClientModelItem(this fnClient arg, double timeZone, bool hideClientContactInfo)
        {
            ...
            return new fnClientModel
            {
                ...
                HasNote = arg.HasNote,
                Balance = Math.Floor((arg.Balance ?? 0) * 100) / 100,
                Info = arg.Info,
        ...
        public static fnProduct MapTofnProduct(this ApiProduct product)
        {
            return new fnProduct
            {
                ...
                {
                    CountryId = x,
                    Type = product.Countries.Type ?? (int)BonusSettingConditionTypes.InSet
                }).ToList(),
            };
        }
        ...
        public static FilterfnPartnerProductSetting MapTofnPartnerProductSettings(this ApiFilterPartnerProductSetting setting)
        {
            return new FilterfnPartnerProductSetting
            {
                ...
                CategoryIds = setting.CategoryIds == null ? new FiltersOperation() : setting.CategoryIds.MapToFiltersOperation(),
        ...
        public static ApiBetsInfo MapToApiBetsInfo(this BetsInfo info)
        {
            return new ApiBetsInfo
            {
                ...
                TotalBetsCount = info.TotalBetsCount,
                TotalPlayersCount = info.TotalPlayersCount,
                TotalGGR = info.TotalGGR,
                TotalBetsFromWebSite = info.TotalBetsFromWebSite,
                TotalBetsCountFromWebSite = info.TotalBetsCountFromWebSite,
                TotalPlayersCountFromWebSite = info.TotalPlayersCountFromWebSite,
                TotalGGRFromWebSite = info.TotalGGRFromWebSite,
                TotalBetsFromMobile = info.TotalBetsFromMobile,
                TotalBetsCountFromMobile = info.TotalBetsCountFromMobile,
                TotalPlayersCountFromMobile = info.TotalPlayersCountFromMobile,
                TotalGGRFromMobile = info.TotalGGRFromMobile,
                TotalBetsCountFromWap = info.TotalBetsCountFromWap,
                TotalBetsFromWap = info.TotalBetsFromWap,
                TotalGGRFromWap = info.TotalGGRFromWap,
                TotalPlayersCountFromWap = info.TotalPlayersCountFromWap,
            };
        }

        public static ApiDepositsInfo MapToApiDepositsInfo(this DepositsInfo info)
        {
            return new ApiDepositsInfo
            {
                Status = info.Status,
                TotalPlayersCount = info.TotalPlayersCount,
                Deposits = info.Deposits.Select(x => new ApiDepositInfo
                {
        ...
        public static ApiWithdrawalsInfo MapToApiWithdrawalsInfo(this WithdrawalsInfo info)
        {
            return new ApiWithdrawalsInfo
            {
                Status = info.Status,
                TotalPlayersCount = info.TotalPlayersCount,
                Withdrawals = info.Withdrawals.Select(x => new ApiWithdrawalInfo
                {
                    PaymentSystemId = x.PaymentSystemId,
                    PaymentSystemName = x.PaymentSystemName,
                    TotalAmount = x.TotalAmount,
        ...
        public static ApiPlayersInfo MapToApiPlayersInfo(this PlayersInfo info)
        {
            return new ApiPlayersInfo
            {
                ...
                AverageBet = info.AverageBet,
                MaxBet = info.MaxBet,
                MaxWin = info.MaxWin,
                DepositsCount = info.DepositsCount,
                MaxWinBet = info.MaxWinBet,
                ReturnsCount = info.ReturnsCount,
                TotalBetAmount = info.TotalBetAmount,
                TotalBonusAmount = info.TotalBonusAmount,
                TotalCashoutAmount = info.TotalCashoutAmount,
                TotalPlayersCount = info.TotalPlayersCount
            };
        }
        ...
        public static ApiProvidersBetsInfo MapToApiProvidersBetsInfo(this ProvidersBetsInfo info)
        {
            return new ApiProvidersBetsInfo
            {
                TotalPlayersCount = info.TotalPlayersCount,
                TotalBetsAmount = info.TotalBetsAmount,
                TotalWinsAmount = info.TotalWinsAmount,
                TotalGGR = info.TotalGGR,
                Bets = info.Bets.Select(x => new ApiProviderBetsInfo
                {
                    ProviderId = x.ProviderId,
                    TotalBetsAmount = x.TotalBetsAmount,
                    TotalWinsAmount = x.TotalWinsAmount,
                    TotalBetsCount = x.TotalBetsCount,
                    TotalGGR = x.TotalGGR,
                    TotalPlayersCount = x.TotalPlayersCount,
                    TotalBetsAmountFromInternet = x.TotalBetsAmountFromInternet,
                    TotalBetsAmountFromBetShop = x.TotalBetsAmountFromBetShop
                }).ToList()
            };
        }
        ...
        public static CurrencyRateModel MapToCurrencyRateModel(this CurrencyRate currencyRate, double timeZone)
        {
            ...
            return new CurrencyRateModel
            {
                ...
                UserId = currencyRate.Session.UserId,
                UserName = currencyRate.Session.User.UserName,
        ...
        public static Bonu MapToBonus(this ApiBonus bonus)
        {
            return new Bonu
            {
                ...
                AccountTypeId = bonus.AccountTypeId,
                Status = bonus.Status,
                ...
                BonusProducts = bonus.Products?.Select(
                    x => new BonusProduct
                    {
                        ...
                        CashBackPercent = x.Percent ?? -1
                    }).ToList(),
                BonusType = bonus.BonusTypeId,
        ...
        public static ApiClientBonus MapToApiClientBonus(this fnClientBonus input, double timeZone)
        {
            return new ApiClientBonus
            {
                ...
                TurnoverAmountLeft = input.BonusType == (int)BonusTypes.CampaignFreeBet ? null : input.TurnoverAmountLeft,
                CreationTime = input.CreationTime.GetGMTDateFromUTC(timeZone),
        ...
        public static ApiBonus MapToApiBonus(this Bonu bonus, double timeZone)
        {
            return new ApiBonus
            {
                ...
                Name = bonus.Name,
                PartnerId = bonus.PartnerId,
                AccountTypeId = bonus.AccountTypeId ?? 0,
                Status = bonus.Status,
                ...
                Period = bonus.Period,
                Percent = (bonus.BonusProducts == null || !bonus.BonusProducts.Any()) ? 0 : bonus.BonusProducts.First().CashBackPercent,
        ...
        public static ApiTriggerSetting MapToApiTriggerSetting(this TriggerSetting triggerSetting, double timeZone)
        {
            ...
            return new ApiTriggerSetting
            {
                ...
                Conditions = string.IsNullOrEmpty(triggerSetting.Condition) || triggerSetting.Type == (int)TriggerTypes.NthDeposit || triggerSetting.Type == (int)TriggerTypes.ManualEvent ?
                    null : JsonConvert.DeserializeObject<Common.Models.Bonus.BonusCondition>(triggerSetting.Condition),
                Status = (triggerSetting.Type != (int)TriggerTypes.ManualEvent || string.IsNullOrEmpty(triggerSetting.Condition)) ? 0 : Convert.ToInt32(triggerSetting.Condition),
                Sequence = triggerSetting.Type == (int)TriggerTypes.NthDeposit ? triggerSetting.Condition : string.Empty,
                Products = triggerSetting.TriggerProductSettings == null ? new List<ApiBonusProducts>() : triggerSetting.TriggerProductSettings.Select(x => new ApiBonusProducts
                {
                    Id = x.Id,
                    ProductId = x.ProductId,
                    Percent = x.Percent
        ...
        public static List<FilterBetShopBet> MaptoFilterBetShopBets(this IEnumerable<ApiFilterBetShopBet> apiFilterBetShopBets)
        {
            return apiFilterBetShopBets.Select(MapToFilterBetShopBet).ToList();
        }
        ...
        public static FilterReportByBonus MapToFilterReportByBonus(this ApiFilterReportByBonus filter)
        {
            return new FilterReportByBonus
            {
                ...
                ClientBonusStatuses = filter.ClientBonusStatuses == null ? new FiltersOperation() : filter.ClientBonusStatuses.MapToFiltersOperation(),
        ...
        public static List<FilterfnBetShop> MapToFilterfnBetShops(this IEnumerable<ApiFilterBetShop> filterBetShops)
        {
            return filterBetShops.Select(MaptToFilterfnBetShop).ToList();
        }
        ...
        public static DAL.Banner MapToBanner(this ApiBanner input)
        {
            return new DAL.Banner
            {
                ...
                BannerSegmentSettings = (input.Segments == null || input.Segments.Ids == null) ? new List<BannerSegmentSetting>() :
                                          input.Segments?.Ids?.Select(x => new BannerSegmentSetting { BannerId = input.Id, SegmentId = x, Type = input.Segments.Type ?? (int)BonusSettingConditionTypes.InSet }).ToList()
            };
        }

        public static ApiBanner ToApiBanner(this DAL.Banner banner)
        {
        ...
        public static ApiPromotion ToApiPromotion(this Promotion input)
        {
        ...
        public static FilterAnnouncement MapToFilterAnnouncement(this ApiFilterAnnouncement filter)
        {
            return new FilterAnnouncement
            {
                ...
                ReceiverTypeId = filter.ReceiverTypeId,
                Type = filter.Type,
                TakeCount = filter.TakeCount,
                SkipCount = filter.SkipCount,
                FromDate = filter.FromDate,
        ...
        public static ApiAnnouncement MapToApiAnnouncement(this fnAnnouncement input, double timeZone)
        {
            return new ApiAnnouncement
            {
                ...
                ReceiverTypeId = input.ReceiverTypeId,
                UserId = input.UserId,
                Type = input.Type,
                State = input.State,
                NickName = input.NickName,
