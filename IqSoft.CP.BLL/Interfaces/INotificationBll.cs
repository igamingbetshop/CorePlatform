...
namespace IqSoft.CP.BLL.Interfaces
{
    ...
    {
        int RegisterActiveEmail(int partnerId, string email, string subject, string body, int? templateId, long? objectId, int? objectTypeId);
        ...
        int SendNotificationMessage(NotificationModel notificationModel, out int responseCode);
